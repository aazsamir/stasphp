...
class GalleryDestroy implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'galleryDestroy';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GalleryDestroyInput $input,
    ) {
    }
