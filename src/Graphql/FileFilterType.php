...
class FileFilterType implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    /** @var array<\Aazsamir\Stasphp\Graphpql\FingerprintFilterInput> */
    public ?array $hashes;
    ...
    /**
     * @param array<\Aazsamir\Stasphp\Graphpql\FingerprintFilterInput> $hashes
     */
    ...
    public static function fromArray(array $data): self
    {
        $self = new self();
        if (isset($data['AND'])) {
            $self->AND = \Aazsamir\Stasphp\Graphpql\FileFilterType::fromArray($data['AND']);
        }
        if (isset($data['OR'])) {
            $self->OR = \Aazsamir\Stasphp\Graphpql\FileFilterType::fromArray($data['OR']);
        }
        if (isset($data['NOT'])) {
            $self->NOT = \Aazsamir\Stasphp\Graphpql\FileFilterType::fromArray($data['NOT']);
        }
        if (isset($data['path'])) {
        ...
        if (isset($data['dir'])) {
            $self->dir = \Aazsamir\Stasphp\Graphpql\StringCriterionInput::fromArray($data['dir']);
        }
        ...
        if (isset($data['duplicated'])) {
            $self->duplicated = \Aazsamir\Stasphp\Graphpql\FileDuplicationCriterionInput::fromArray($data['duplicated']);
        }
        if (isset($data['hashes'])) {
            $self->hashes = array_map(function ($data) {
                ...
                return \Aazsamir\Stasphp\Graphpql\FingerprintFilterInput::fromArray($data);
            }, $data['hashes'] ?? []);
        }
        if (isset($data['video_file_filter'])) {
            $self->video_file_filter = \Aazsamir\Stasphp\Graphpql\VideoFileFilterInput::fromArray($data['video_file_filter']);
        }
        if (isset($data['image_file_filter'])) {
            $self->image_file_filter = \Aazsamir\Stasphp\Graphpql\ImageFileFilterInput::fromArray($data['image_file_filter']);
        }
