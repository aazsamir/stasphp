 ...
 * @template T
 */
class VideoFileField implements \Aazsamir\Graphpql\Model\ObjectField
{
    private string $name;
    ...
    /**
     * @return self<\Aazsamir\Stasphp\Graphpql\SelectionSet\FingerprintSelectionSet>
     */
    public static function fingerprints(): self
    {
        $instance = new self();
        $instance->name = 'fingerprints';
        $instance->child = new \Aazsamir\Stasphp\Graphpql\SelectionSet\FingerprintSelectionSet();
     ...
     * @return self<mixed>
     */
    public static function frame_rate(): self
    {
        $instance = new self();
        $instance->name = 'frame_rate';
     ...
     * @return self<mixed>
     */
    public static function bit_rate(): self
    {
        $instance = new self();
        $instance->name = 'bit_rate';
