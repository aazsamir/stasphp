...
class StudioDestroy implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'studioDestroy';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\StudioDestroyInput $input,
    ) {
    }
