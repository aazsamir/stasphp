...
class PerformerUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'performerUpdate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphql\PerformerUpdateInput $input,
    ) {
    }
    ...
    public function do(): ?\Aazsamir\Stasphp\Graphql\Performer
    {
        ...
        return \Aazsamir\Stasphp\Graphql\Performer::fromArray($response->data);
    }
