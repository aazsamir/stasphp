...
class BulkGalleryUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'bulkGalleryUpdate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\BulkGalleryUpdateInput $input,
    ) {
    }
