...
class MetadataIdentify implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'metadataIdentify';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\IdentifyMetadataInput $input,
    ) {
    }
