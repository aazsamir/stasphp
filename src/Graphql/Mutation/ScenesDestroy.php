...
class ScenesDestroy implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'scenesDestroy';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\ScenesDestroyInput $input,
    ) {
    }
