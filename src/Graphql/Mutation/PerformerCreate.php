...
class PerformerCreate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'performerCreate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphql\PerformerCreateInput $input,
    ) {
    }
