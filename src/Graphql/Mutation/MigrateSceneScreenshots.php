...
class MigrateSceneScreenshots implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'migrateSceneScreenshots';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\MigrateSceneScreenshotsInput $input,
    ) {
    }
