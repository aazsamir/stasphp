...
class AddGroupSubGroups implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'addGroupSubGroups';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GroupSubGroupAddInput $input,
    ) {
    }
