...
class StashBox implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    /**
     * @return \Aazsamir\Stasphp\Graphpql\Fields\StashBoxField<mixed>
     */
    public static function endpoint(): Fields\StashBoxField
    {
        return \Aazsamir\Stasphp\Graphpql\Fields\StashBoxField::endpoint();
    }
    ...
    {
        return \Aazsamir\Stasphp\Graphpql\Fields\StashBoxField::api_key();
    }
    ...
    {
        return \Aazsamir\Stasphp\Graphpql\Fields\StashBoxField::name();
    }
    ...
    {
        return \Aazsamir\Stasphp\Graphpql\Fields\StashBoxField::max_requests_per_minute();
    }
