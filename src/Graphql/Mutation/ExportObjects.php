...
class ExportObjects implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'exportObjects';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\ExportObjectsInput $input,
    ) {
    }
