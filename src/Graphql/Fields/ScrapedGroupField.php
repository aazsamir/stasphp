 ...
 * @template T
 */
class ScrapedGroupField implements \Aazsamir\Graphpql\Model\ObjectField
{
    private string $name;
     ...
     * @return self<mixed>
     */
    public static function front_image(): self
    {
        $instance = new self();
        $instance->name = 'front_image';
     ...
     * @return self<mixed>
     */
    public static function back_image(): self
    {
        $instance = new self();
        $instance->name = 'back_image';
