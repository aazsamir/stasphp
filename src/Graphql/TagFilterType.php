...
class TagFilterType implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    public static function fromArray(array $data): self
    {
        $self = new self();
        if (isset($data['AND'])) {
            $self->AND = \Aazsamir\Stasphp\Graphpql\TagFilterType::fromArray($data['AND']);
        }
        if (isset($data['OR'])) {
            $self->OR = \Aazsamir\Stasphp\Graphpql\TagFilterType::fromArray($data['OR']);
        }
        if (isset($data['NOT'])) {
            $self->NOT = \Aazsamir\Stasphp\Graphpql\TagFilterType::fromArray($data['NOT']);
        }
        if (isset($data['name'])) {
            $self->name = \Aazsamir\Stasphp\Graphpql\StringCriterionInput::fromArray($data['name']);
        }
        if (isset($data['sort_name'])) {
            $self->sort_name = \Aazsamir\Stasphp\Graphpql\StringCriterionInput::fromArray($data['sort_name']);
        }
        ...
        if (isset($data['description'])) {
            $self->description = \Aazsamir\Stasphp\Graphpql\StringCriterionInput::fromArray($data['description']);
        }
        ...
        if (isset($data['studio_count'])) {
            $self->studio_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['studio_count']);
        }
        if (isset($data['movie_count'])) {
            $self->movie_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['movie_count']);
        }
        if (isset($data['group_count'])) {
            $self->group_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['group_count']);
        }
        if (isset($data['marker_count'])) {
            $self->marker_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['marker_count']);
        }
        if (isset($data['parents'])) {
            $self->parents = \Aazsamir\Stasphp\Graphpql\HierarchicalMultiCriterionInput::fromArray($data['parents']);
        }
        if (isset($data['children'])) {
            $self->children = \Aazsamir\Stasphp\Graphpql\HierarchicalMultiCriterionInput::fromArray($data['children']);
        }
        if (isset($data['parent_count'])) {
            $self->parent_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['parent_count']);
        }
        if (isset($data['child_count'])) {
            $self->child_count = \Aazsamir\Stasphp\Graphpql\IntCriterionInput::fromArray($data['child_count']);
        }
