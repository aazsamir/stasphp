...
class PerformerDestroy implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'performerDestroy';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\PerformerDestroyInput $input,
    ) {
    }
