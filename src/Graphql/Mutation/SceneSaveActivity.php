...
class SceneSaveActivity implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'sceneSaveActivity';
    ...
    public function __construct(
        public string $id,
        public ?float $resume_time = null,
        public ?float $playDuration = null,
    ) {
    }
