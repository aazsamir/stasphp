...
class SubmitStashBoxFingerprints implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'submitStashBoxFingerprints';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\StashBoxFingerprintSubmissionInput $input,
    ) {
    }
