...
class AnonymiseDatabase implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'anonymiseDatabase';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\AnonymiseDatabaseInput $input,
    ) {
    }
