...
class MetadataCleanGenerated implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'metadataCleanGenerated';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\CleanGeneratedInput $input,
    ) {
    }
