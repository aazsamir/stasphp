...
class RemoveGalleryImages implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'removeGalleryImages';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GalleryRemoveInput $input,
    ) {
    }
