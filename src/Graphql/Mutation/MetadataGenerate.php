...
class MetadataGenerate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'metadataGenerate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GenerateMetadataInput $input,
    ) {
    }
