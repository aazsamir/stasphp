...
class SceneAssignFile implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'sceneAssignFile';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\AssignSceneFileInput $input,
    ) {
    }
