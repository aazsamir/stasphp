...
class FindSceneByHash implements \Aazsamir\Graphpql\Model\Query
{
    public const NAME = 'findSceneByHash';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphql\SceneHashInput $input,
    ) {
    }
    ...
    public function do(): ?\Aazsamir\Stasphp\Graphql\Scene
    {
        ...
        return \Aazsamir\Stasphp\Graphql\Scene::fromArray($response->data);
    }
