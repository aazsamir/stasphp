...
class RemoveGroupSubGroups implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'removeGroupSubGroups';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GroupSubGroupRemoveInput $input,
    ) {
    }
