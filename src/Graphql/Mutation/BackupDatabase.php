...
class BackupDatabase implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'backupDatabase';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\BackupDatabaseInput $input,
    ) {
    }
