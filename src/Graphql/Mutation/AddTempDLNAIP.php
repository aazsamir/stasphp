...
class AddTempDLNAIP implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'addTempDLNAIP';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\AddTempDLNAIPInput $input,
    ) {
    }
