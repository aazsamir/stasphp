...
class ResetGalleryCover implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'resetGalleryCover';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GalleryResetCoverInput $input,
    ) {
    }
