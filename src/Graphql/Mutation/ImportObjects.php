...
class ImportObjects implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'importObjects';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\ImportObjectsInput $input,
    ) {
    }
