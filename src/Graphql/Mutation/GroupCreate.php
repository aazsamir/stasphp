...
class GroupCreate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'groupCreate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphql\GroupCreateInput $input,
    ) {
    }
    ...
    public function do(): ?\Aazsamir\Stasphp\Graphql\Group
    {
        ...
        return \Aazsamir\Stasphp\Graphql\Group::fromArray($response->data);
    }
