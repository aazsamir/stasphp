...
class MetadataAutoTag implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'metadataAutoTag';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\AutoTagMetadataInput $input,
    ) {
    }
