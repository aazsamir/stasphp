...
class StashBoxBatchPerformerTag implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'stashBoxBatchPerformerTag';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\StashBoxBatchTagInput $input,
    ) {
    }
