...
class TagUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'tagUpdate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphql\TagUpdateInput $input,
    ) {
    }
    ...
    public function do(): ?\Aazsamir\Stasphp\Graphql\Tag
    {
        ...
        return \Aazsamir\Stasphp\Graphql\Tag::fromArray($response->data);
    }
