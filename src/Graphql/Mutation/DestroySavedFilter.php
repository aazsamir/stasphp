...
class DestroySavedFilter implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'destroySavedFilter';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\DestroyFilterInput $input,
    ) {
    }
