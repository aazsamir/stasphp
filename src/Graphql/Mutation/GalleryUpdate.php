...
class GalleryUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'galleryUpdate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GalleryUpdateInput $input,
    ) {
    }
