...
class ReorderSubGroups implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'reorderSubGroups';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\ReorderSubGroupsInput $input,
    ) {
    }
