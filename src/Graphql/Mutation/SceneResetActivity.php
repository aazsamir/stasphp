...
class SceneResetActivity implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'sceneResetActivity';
    ...
    public function __construct(
        public string $id,
        public ?bool $reset_resume = null,
        public ?bool $reset_duration = null,
    ) {
    }
    ...
    public function getVars(): array
    {
        return [
            'id' => $this->id,
            'reset_resume' => $this->reset_resume,
            'reset_duration' => $this->reset_duration,
        ];
    }
