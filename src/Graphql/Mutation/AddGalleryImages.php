...
class AddGalleryImages implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'addGalleryImages';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GalleryAddInput $input,
    ) {
    }
