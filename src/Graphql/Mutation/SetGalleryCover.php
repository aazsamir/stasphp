...
class SetGalleryCover implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'setGalleryCover';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\GallerySetCoverInput $input,
    ) {
    }
