...
class BulkTagUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    public const NAME = 'bulkTagUpdate';
    ...
    public function __construct(
        public \Aazsamir\Stasphp\Graphpql\BulkTagUpdateInput $input,
    ) {
    }
